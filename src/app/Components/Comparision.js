                        ...
                        <div className='fetureBoxContainer'>
                            <div className='fetureBox'>
                                <div className='listingName'>
                                    ...
                                    <ul className='ps-0' style={{ paddingTop: '29px' }}>
                                ...
                                <div className='listingName'>
                                    ...
                                    <ul className='ps-0'>
                                        <li className='feature_listing listing_flexBox'> <Image src="/images/tick.svg" alt="tick" width={42} height={42} /> <span>Semantic Search with CDR</span></li>
